...
changepoint_tally_filename = os.path.join(base_dir, "output_data/changepoint_tallies.csv")
# Name of Fig
figure_filename = os.path.join(base_dir, "visualizations/changepoint_tallies.png")
...
def tally_visualization(filename):
    ...
    features = {'Tonality': 0, 'MIC': 0, 'Pitch.STD': 0, 'MIS': 0, 'Onset.Density': 0, 'nPVI': 0, 'RIC': 0, 'Multivariate':0}
    ...
    ax2.plot(years, features['Pitch.STD'])
    ...
    ax4.plot(years, features['Onset.Density'])
